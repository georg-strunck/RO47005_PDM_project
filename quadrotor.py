...
class Quadrotor(core.Env):
    ...
    def __init__(self):
        ...
        # added an action space and observation_space
        self.action_space = spaces.Box(0, 1600,shape =(1,4)) # 4 diffent acitons variables are used in the 3D plot         
        self.observation_space = spaces.Box(-12000, -12000,shape=(1,13)) # 13 different states are defined
